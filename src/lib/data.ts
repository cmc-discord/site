...
export type NavigationItem = { path: string, children: NavigationList | undefined }
...
export type RichNavigationItem = SlugWithArticle & { path: string, children: RichNavigationList}
